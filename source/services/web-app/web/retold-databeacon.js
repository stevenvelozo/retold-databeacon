...
const libCodeDemos=require('./demos');module.exports.demos=libCodeDemos.demos;module.exports.registerWithDocuserve=libCodeDemos.registerWithDocuserve;},{"./Pict-Code-Highlighter.js":14,"./Pict-Section-Code-DefaultConfiguration.js":15,"./demos":17,"pict-view":82}],17:[function(require,module,exports){/**
...
let tmpButtonContainer=tmpOAuthAreaElements[0].querySelector('#pict-login-oauth-buttons');if(!tmpButtonContainer){return;}let tmpButtonsHTML='';for(let i=0;i<this.oauthProviders.length;i++){let tmpProvider=this.oauthProviders[i];let tmpName=tmpProvider.Name||'provider';let tmpBeginURL=tmpProvider.BeginURL||this.options.OAuthBeginEndpoint+'/'+tmpName;let tmpDisplayName=tmpName.charAt(0).toUpperCase()+tmpName.slice(1);let tmpCSSModifier=tmpName.toLowerCase();tmpButtonsHTML+='<a class="pict-login-oauth-btn pict-login-oauth-btn--'+tmpCSSModifier+'" href="'+tmpBeginURL+'">Sign in with '+tmpDisplayName+'</a>';}tmpButtonContainer.innerHTML=tmpButtonsHTML;}/**
	 ...
	 */_solveApp(){if(this.pict&&this.pict.PictApplication&&typeof this.pict.PictApplication.solve==='function'){this.pict.PictApplication.solve();}}}module.exports=PictSectionLogin;module.exports.default_configuration=_DefaultConfiguration;},{"./Pict-Section-Login-DefaultConfiguration.js":20,"pict-view":82}],22:[function(require,module,exports){/**
 * Pict-Modal-Confirm
 *
...
fResolve(pResult);}/**
	 ...
	 * @param {string} pText
	 * @returns {string}
	 */_escapeHTML(pText){if(typeof pText!=='string'){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=PictModalConfirm;},{}],23:[function(require,module,exports){/**
 * Pict-Modal-Dropdown
 *
...
setTimeout(()=>{if(tmpElement.parentNode){tmpElement.parentNode.removeChild(tmpElement);}},220);this._element=null;this._currentClickHandler=null;}}}/**
	 ...
	 */destroy(){this._refCount=0;if(this._element&&this._element.parentNode){this._element.parentNode.removeChild(this._element);}this._element=null;this._currentClickHandler=null;}}module.exports=PictModalOverlay;},{}],25:[function(require,module,exports){/**
 * Pict-Modal-Panel
 *
...
let tmpHandle={id:tmpId,collapse:tmpCollapse,expand:tmpExpand,toggle:tmpToggle,setWidth:tmpSetWidth,destroy:tmpDestroy};this._panels.push(tmpHandle);return tmpHandle;}/**
	 ...
	 */destroyAll(){let tmpPanels=this._panels.slice();for(let i=0;i<tmpPanels.length;i++){tmpPanels[i].destroy();}}}module.exports=PictModalPanel;},{}],26:[function(require,module,exports){/**
...
if(tmpOptions.duration>0){tmpTimeoutHandle=setTimeout(tmpDismiss,tmpOptions.duration);}return tmpHandle;}/**
	 ...
	 * @param {string} pText
	 * @returns {string}
	 */_escapeHTML(pText){if(typeof pText!=='string'){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=PictModalToast;},{}],28:[function(require,module,exports){/**
 * Pict-Modal-Tooltip
 *
...
tmpLeft=Math.max(4,Math.min(tmpLeft,window.innerWidth-tmpTooltipRect.width-4));tmpTop=Math.max(4,Math.min(tmpTop,window.innerHeight-tmpTooltipRect.height-4));pTooltip.style.top=tmpTop+'px';pTooltip.style.left=tmpLeft+'px';}/**
	 ...
	 */dismissAll(){let tmpTooltips=this._modal._activeTooltips.slice();for(let i=0;i<tmpTooltips.length;i++){tmpTooltips[i].destroy();}}}module.exports=PictModalTooltip;},{}],29:[function(require,module,exports){/**
 * Pict-Modal-Window
 *
...
/**
	 ...
	 *//**
	 * Destroy all active panels.
	 */destroyPanels(){this._panel.destroyAll();}destroy(){this.dismissAll();this.destroyPanels();this._overlay.destroy();this._toast.destroy();if(typeof super.destroy==='function'){return super.destroy();}}}module.exports=PictSectionModal;module.exports.default_configuration=_DefaultConfiguration;},{"./Pict-Modal-Confirm.js":22,"./Pict-Modal-Dropdown.js":23,"./Pict-Modal-Overlay.js":24,"./Pict-Modal-Panel.js":25,"./Pict-Modal-Shell.js":26,"./Pict-Modal-Toast.js":27,"./Pict-Modal-Tooltip.js":28,"./Pict-Modal-Window.js":29,"./Pict-Section-Modal-DefaultConfiguration.js":30,"pict-view":82}],32:[function(require,module,exports){/**
...
module.exports.registerCatalog=registerCatalog;module.exports.listCatalog=listCatalog;module.exports.install=install;module.exports.clearPersistence=clearPersistence;},{"./Theme-Brand.js":33,"./Theme-Persistence.js":35,"./Theme-Scale.js":36,"./themes/_catalog.js":40,"./views/PictView-Theme-BottomBar.js":71,"./views/PictView-Theme-Brand-Mark.js":72,"./views/PictView-Theme-BrandStrip.js":73,"./views/PictView-Theme-Button.js":74,"./views/PictView-Theme-ModeToggle.js":75,"./views/PictView-Theme-Picker.js":76,"./views/PictView-Theme-ScaleSelect.js":77,"./views/PictView-Theme-TopBar.js":78,"pict-provider":12,"pict-provider-theme":6}],33:[function(require,module,exports){/**
 ...
 */function reset(){applyBrand(null);_listeners=[];}module.exports={applyBrand:applyBrand,getActive:getActive,onChange:onChange,offChange:offChange,reset:reset,STYLE_ELEMENT_ID:STYLE_ELEMENT_ID,FAVICON_LINK_ID:FAVICON_LINK_ID,FAVICON_DARK_LINK_ID:FAVICON_DARK_LINK_ID};},{}],34:[function(require,module,exports){/**
 ...
 * defaults" actions.
 */function clear(pKey){let tmpStore=_getStorage();if(!tmpStore)return false;try{tmpStore.removeItem(pKey);return true;}catch(pErr){return false;}}module.exports={resolveKey:resolveKey,load:load,save:save,clear:clear,STORAGE_PREFIX:STORAGE_PREFIX,SCHEMA_VERSION:SCHEMA_VERSION};},{}],36:[function(require,module,exports){/**
...
if(tmpIsRootRenderable&&pRenderable&&pRenderable.TransactionHash){this.pict.TransactionTracking.unregisterTransaction(pRenderable.TransactionHash);}return fCallback(pError);});}/**
	 ...
	 *
	 * @param {ErrorCallback} fCallback - The callback to call when the async operation is complete.
	 */onAfterMarshalToViewAsync(fCallback){this.onAfterMarshalToView();return fCallback();}/** @return {boolean} - True if the object is a PictView. */get isPictView(){return true;}}module.exports=PictView;},{"../package.json":81,"fable-serviceproviderbase":2}],83:[function(require,module,exports){/**
...
_form(pViewName){return this.pict.views[pViewName]||{_submit:()=>{}};}}module.exports=DataBeaconApplication;module.exports.default_configuration={};},{"./DataBeacon-Brand.js":85,"./providers/Pict-Provider-DataBeacon-Export.js":88,"./providers/Pict-Provider-DataBeacon-Icons.js":89,"./providers/Pict-Provider-DataBeacon-SavedQueries.js":90,"./providers/Pict-Provider-DataBeacon.js":91,"./providers/PictRouter-DataBeacon-Configuration.json":92,"./views/PictView-DataBeacon-ConnectionForm.js":93,"./views/PictView-DataBeacon-ConnectionList.js":94,"./views/PictView-DataBeacon-Connections.js":95,"./views/PictView-DataBeacon-Dashboard.js":96,"./views/PictView-DataBeacon-Endpoints.js":97,"./views/PictView-DataBeacon-Introspection.js":98,"./views/PictView-DataBeacon-IntrospectionControls.js":99,"./views/PictView-DataBeacon-IntrospectionTables.js":100,"./views/PictView-DataBeacon-Layout.js":101,"./views/PictView-DataBeacon-Login.js":102,"./views/PictView-DataBeacon-QueryPanel.js":103,"./views/PictView-DataBeacon-RecordBrowser.js":104,"./views/PictView-DataBeacon-Records.js":105,"./views/PictView-DataBeacon-SQL.js":106,"./views/PictView-DataBeacon-SavedQueriesList.js":107,"./views/PictView-DataBeacon-SettingsPanel.js":108,"./views/PictView-DataBeacon-Sidebar.js":109,"./views/PictView-DataBeacon-TopBar-Nav.js":110,"./views/PictView-DataBeacon-TopBar-User.js":111,"pict-application":5,"pict-router":13,"pict-section-code":16,"pict-section-connection-form":19,"pict-section-login":21,"pict-section-modal":31,"pict-section-theme":32,"ultravisor-beacon/webinterface/Pict-Beacon-WebAuth-Client.js":83}],87:[function(require,module,exports){/**
...
window.DataBeaconApplication=libDataBeaconApplication;},{"./Pict-Application-DataBeacon.js":86,"./providers/Pict-Provider-DataBeacon-Export.js":88,"./providers/Pict-Provider-DataBeacon-Icons.js":89,"./providers/Pict-Provider-DataBeacon-SavedQueries.js":90,"./providers/Pict-Provider-DataBeacon.js":91,"./views/PictView-DataBeacon-ConnectionForm.js":93,"./views/PictView-DataBeacon-ConnectionList.js":94,"./views/PictView-DataBeacon-Connections.js":95,"./views/PictView-DataBeacon-Dashboard.js":96,"./views/PictView-DataBeacon-Endpoints.js":97,"./views/PictView-DataBeacon-Introspection.js":98,"./views/PictView-DataBeacon-IntrospectionControls.js":99,"./views/PictView-DataBeacon-IntrospectionTables.js":100,"./views/PictView-DataBeacon-Layout.js":101,"./views/PictView-DataBeacon-QueryPanel.js":103,"./views/PictView-DataBeacon-RecordBrowser.js":104,"./views/PictView-DataBeacon-Records.js":105,"./views/PictView-DataBeacon-SQL.js":106,"./views/PictView-DataBeacon-SavedQueriesList.js":107,"./views/PictView-DataBeacon-SettingsPanel.js":108,"./views/PictView-DataBeacon-Sidebar.js":109,"./views/PictView-DataBeacon-TopBar-Nav.js":110,"./views/PictView-DataBeacon-TopBar-User.js":111,"pict-application":5,"pict-router":13,"pict-section-code":16,"pict-section-theme":32,"pict-view":82}],88:[function(require,module,exports){/**
...
let tmpFormView=this.pict.views['PictSection-ConnectionForm'];let tmpConnInfo=tmpFormView&&typeof tmpFormView.getProviderConfig==='function'?tmpFormView.getProviderConfig():{Provider:'MySQL',Config:{}};this.pict.providers.DataBeaconProvider.createConnection({Name:tmpName,Type:tmpConnInfo.Provider||'MySQL',Config:tmpConnInfo.Config||{},AutoConnect:tmpAutoConnect,Description:tmpDescription});}}module.exports=PictViewDataBeaconConnectionForm;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],94:[function(require,module,exports){/**
...
<tr>
	...
	<td>{~D:Record.Type~}</td>
	<td><span class="badge {~D:Record.StatusBadgeClass~}">{~D:Record.StatusLabel~}</span></td>
</tr>`}],Renderables:[{RenderableHash:'DataBeacon-Dashboard',TemplateHash:'DataBeacon-Dashboard-Template',ContentDestinationAddress:'#DataBeacon-View-Dashboard',RenderMethod:'replace'}]};class PictViewDataBeaconDashboard extends libPictView{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){let tmpIcons=this.pict.providers['DataBeacon-Icons'];if(tmpIcons)tmpIcons.injectIconPlaceholders('#DataBeacon-View-Dashboard');return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconDashboard;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],97:[function(require,module,exports){/**
...
let tmpProvider=this.pict.providers.DataBeaconProvider;if(tmpProvider&&typeof tmpProvider.refreshIntrospectionViewData==='function'){tmpProvider.refreshIntrospectionViewData();}return super.onBeforeRender(pRenderable);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){if(this.pict.views.IntrospectionControls)this.pict.views.IntrospectionControls.render();if(this.pict.views.IntrospectionTables)this.pict.views.IntrospectionTables.render();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconIntrospection;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],99:[function(require,module,exports){/**
...
let tmpView=this.pict.views[pViewName];if(tmpView&&typeof tmpView.render==='function'){tmpView.render();}}}module.exports=PictViewDataBeaconLayout;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],102:[function(require,module,exports){/**
...
</div>`}],Renderables:[{RenderableHash:'DataBeacon-SQLPage',TemplateHash:'DataBeacon-SQLPage-Template',ContentDestinationAddress:'#DataBeacon-View-SQL',RenderMethod:'replace'}]};class PictViewDataBeaconSQL extends libPictView{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){if(this.pict.views.SavedQueriesList)this.pict.views.SavedQueriesList.render();if(this.pict.views.QueryPanel)this.pict.views.QueryPanel.render();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconSQL;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],107:[function(require,module,exports){/**
...
let tmpIcons=this.pict.providers['DataBeacon-Icons'];if(tmpIcons&&typeof tmpIcons.injectIconPlaceholders==='function'){tmpIcons.injectIconPlaceholders('#DataBeacon-Sidebar-Host');}this.pict.CSSMap.injectCSS();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconSidebar;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],110:[function(require,module,exports){/**
...
</div>`}],Renderables:[{RenderableHash:'DataBeacon-TopBar-Nav-Display',TemplateHash:'DataBeacon-TopBar-Nav-Template',ContentDestinationAddress:'#Theme-TopBar-Nav',RenderMethod:'replace'}]};class PictViewDataBeaconTopBarNav extends libPictView{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent){this.pict.CSSMap.injectCSS();return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconTopBarNav;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}],111:[function(require,module,exports){/**
...
let tmpIcons=this.pict.providers['DataBeacon-Icons'];if(tmpIcons&&typeof tmpIcons.injectIconPlaceholders==='function'){tmpIcons.injectIconPlaceholders('#Theme-TopBar-User');}return super.onAfterRender(pRenderable,pRenderDestinationAddress,pRecord,pContent);}}module.exports=PictViewDataBeaconTopBarUser;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":82}]},{},[87])(87);});
