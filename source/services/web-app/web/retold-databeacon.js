  ...
  return function () {
	...
	<div id="DataBeacon-TableDetail" class="section" style="display:none;"></div>`;
        ...
        _renderTables(pTables, pCID, pConnection) {
          ...
          for (let i = 0; i < pTables.length; i++) {
            ...
            let tmpBtn = tmpTable.EndpointsEnabled ? `<button class="btn btn-small btn-warning" onclick="DataBeacon_disableEndpoint(${pCID},'${tmpTable.TableName}')">Disable</button>` : `<button class="btn btn-small btn-primary" onclick="DataBeacon_enableEndpoint(${pCID},'${tmpTable.TableName}')">Enable</button>`;
	...
	<div class="section">
        ...
        _showDetail(pCID, pTableName) {
          ...
          this.pict.providers.DataBeaconProvider.loadTableDetails(pCID, pTableName, (pError, pData) => {
